	...
	<div class="xf__container xf__entry-container">
		...
		<div class="entry-content">
			...
			<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
				...
				<p><?php printf( wp_kses( __( 'Ready to publish your first post? <a href="%s">Get started here</a>.', 'snowbird' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( admin_url( 'post-new.php' ) ) ); ?></p>
