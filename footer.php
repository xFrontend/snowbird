<footer class="xf__footer" itemtype="http://schema.org/WPFooter" itemscope="itemscope">
	...
	<div class="xf__site-info clear">
		<div class="xf__container">
			...
			<p class="xf__copyright"><?php
				/* translators: 1. Current Year 2. Site Link 3. WordPress Link 4. xFrontend Link */
				echo apply_filters( 'snowbird_footer_text', sprintf( esc_html__( '&copy; %1$d %2$s. Powered by %3$s &amp; %4$s.', 'snowbird' ),
					date( 'Y' ),
					sprintf(
